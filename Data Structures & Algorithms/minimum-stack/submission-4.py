...
class MinStack:
    ...
    def push(self, val: int) -> None:
        ...
        if self.min_stack.next_:
            ...
            self.min_stack.next_ = Node(val, None)
    ...
    def top(self) -> int:
        return self.stack.next_.val if self.stack.next_ else None
        

    def getMin(self) -> int:
        return self.min_stack.next_.val if self.min_stack.next_ else None
